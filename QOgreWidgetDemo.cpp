...
QOgreWidgetDemo::QOgreWidgetDemo()
{
  ...
  // Give focus to our application and make it visible
  this->show();
}
...
//------------------------------------------------------------------------------
void QOgreWidgetDemo::ogreMousePressEvent(QMouseEvent *_event)
{
  mCameraMan->injectMouseDown(*_event);
}

//------------------------------------------------------------------------------
void QOgreWidgetDemo::ogreMouseMoveEvent(QMouseEvent *_event)
{
  ...
  mCameraMan->injectMouseMove(*_event);
}
